...
#include "../include/ICP/icpPointToPoint.h"

using namespace std;

// Also see (3d part): "Least-Squares Fitting of Two 3-D Point Sets" (Arun, Huang and Blostein)
double IcpPointToPoint::fitStep (float *T,const int32_t T_num,Matrix &R,Matrix &t,const std::vector<int32_t> &active) {
...
std::vector<int32_t> IcpPointToPoint::getInliers (float *T,const int32_t T_num,const Matrix &R,const Matrix &t,const double indist) {
